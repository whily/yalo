...
(defparameter *x86-64-syntax-64-bit-only*
  `(,@(arith-syntax-1 'adc t)
    ...
    ((mov    qword m (imm32 imm16 imm8 imm label)) . (#xc7 /0 io))
    ((movzx  r64 (r/m8 r8))                  . (#x0f #xb6 /r))
    ((movzx  r64 byte m)                     . (#x0f #xb6 /r))
    ((movzx  r64 (r/m16 r16))                . (#x0f #xb7 /r))
    ((movzx  r64 word m)                     . (#x0f #xb7 /r))
