  ...
  (let ((base   ; Base opcode for operation on r/m8 r8.
    ...
    (if 64bit-only?
        `(;; TODO: For imm8, encode with imm8 with generic r64
          ...
          ((,mnemonic rax (imm32 imm16 imm8))    . (rex.w ,(+ base #x05) id))
...
(defun shift-syntax (mnemonic)
  ...
  (let ((opcode (ecase mnemonic
    ...
    `(((,mnemonic r8 1)                      . (#xd0 ,opcode))
      ...
      ((,mnemonic r32 1)                     . (#xd1 ,opcode))
      ((,mnemonic dword m 1)                 . (#xd1 ,opcode))
      ((,mnemonic r32 cl)                    . (#xd3 ,opcode))
      ((,mnemonic dword m cl)                . (#xd3 ,opcode))
...
(defun bit-syntax (mnemonic 64bit-only?)
  ...
  (let ((base   ; Base opcode for operation on r/m16, r16, r/m32, r32, r/m64, r64.
    ...
    (if 64bit-only?
        `(((,mnemonic (r/m64 r64 m) r64)  . (rex.w #x0f ,(+ base #xa3) /r))
          ((,mnemonic (r/m64 r64 m) imm8) . (rex.w #x0f #xba ,opcode ib)))
...
(defparameter *x86-64-syntax-common*
  `(,@(arith-syntax-1 'adc nil)
    ...
    ,@(bit-syntax 'btr nil)
    ,@(bit-syntax 'bts nil)
    ((bsf r16 (r/m16 r16 m))                 . (o16 #x0f #xbc /r))
    ((bsf r32 (r/m32 r32 m))                 . (o32 #x0f #xbc /r))
    ((bsr r16 (r/m16 r16 m))                 . (o16 #x0f #xbd /r))
    ((bsr r32 (r/m32 r32 m))                 . (o32 #x0f #xbd /r))
    ...
    ((movsw)                                 . (o16 #xa5))
    ((movsd)                                 . (o32 #xa5))
    ((movzx  r16 (r/m8 r8 m))                . (o16 #x0f #xb6 /r))
    ...
    ((test    (r/m32 r32 m) (imm32 imm16 imm8)) . (#xf7 /0 id))
    ((test    dword m (imm32 imm16 imm8))       . (#xf7 /0 iw))
...
(defparameter *x86-64-syntax-64-bit-only*
  `(,@(arith-syntax-1 'adc t)
    ...
    ,@(bit-syntax 'btr t)
    ,@(bit-syntax 'bts t)
    ((bsf r64 (r/m64 r64 m))                 . (rex.w #x0f #xbc /r))
    ((bsr r64 (r/m64 r64 m))                 . (rex.w #x0f #xbd /r))
    ((cmovcc r64 (r/m64 r64 m))              . (rex.w #x0f (+ #x40 cc) /r))
    ((cmpxchg (r/m64 r64 m) r64)             . (rex.w #x0f #xb1 /r))
    ...
    ((syscall)                               . (#x0f #x05))
    ((sysret)                                . (#x0f #x07))
    ((xadd (r/m64 r64 m) r64)                . (rex.w #x0f #xc1 /r))
    ((xchg    r64 rax)                       . (rex.w (+ #x90 r)))
    ((xchg    (r/m64 r64 m) r64)             . (rex.w #x87 /r))
    ((xchg    r64 (r/m64 r64 m))             . (rex.w #x87 /r))
